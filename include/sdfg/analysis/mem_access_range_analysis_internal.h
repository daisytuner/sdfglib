...
private:
    ...
    void process_direct_users(WorkItem* item, const std::string* varName, bool is_write, std::vector<User*> accesses);

    MemAccessRangesBuilder(StructuredSDFG& sdfg, Users& users, AssumptionsAnalysis& assumptions_analysis)
