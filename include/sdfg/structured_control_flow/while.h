...
private:
    ...
    While(size_t element_id, const DebugInfoRegion& debug_info);
...
private:
    Break(size_t element_id, const DebugInfoRegion& debug_info);
...
private:
    Continue(size_t element_id, const DebugInfoRegion& debug_info);
