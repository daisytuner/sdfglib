...
class DotVisualizer : public Visualizer {
   private:
    ...
    virtual void visualizeBlock(const StructuredSDFG& sdfg,
                                const structured_control_flow::Block& block) override;
    virtual void visualizeSequence(const StructuredSDFG& sdfg,
                                   const structured_control_flow::Sequence& sequence) override;
    virtual void visualizeIfElse(const StructuredSDFG& sdfg,
                                 const structured_control_flow::IfElse& if_else) override;
    virtual void visualizeWhile(const StructuredSDFG& sdfg,
                                const structured_control_flow::While& while_loop) override;
    ...
    virtual void visualizeReturn(const StructuredSDFG& sdfg,
                                 const structured_control_flow::Return& return_node) override;
    virtual void visualizeBreak(const StructuredSDFG& sdfg,
                                const structured_control_flow::Break& break_node) override;
    virtual void visualizeContinue(const StructuredSDFG& sdfg,
                                   const structured_control_flow::Continue& continue_node) override;
    virtual void visualizeMap(const StructuredSDFG& sdfg,
                              const structured_control_flow::Map& map_node) override;
