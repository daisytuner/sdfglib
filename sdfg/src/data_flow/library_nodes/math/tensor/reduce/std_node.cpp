...
bool StdNode::expand(builder::StructuredSDFGBuilder& builder, analysis::AnalysisManager& analysis_manager) {
    ...
    types::Scalar element_type(out_edge.base_type().primitive_type());
    ...
    auto& pow_node_1 = builder.add_library_node<
        math::tensor::ElementwiseNode>(pow_block, pow_block.debug_info(), data_flow::TaskletCode::fp_mul);
    builder
    ...
    auto& pow_node_2 = builder.add_library_node<
        math::tensor::ElementwiseNode>(pow_mean_x_block, pow_mean_x_block.debug_info(), data_flow::TaskletCode::fp_mul);
    ...
    auto& sub_node = builder.add_library_node<
        math::tensor::ElementwiseNode>(sub_block, sub_block.debug_info(), data_flow::TaskletCode::fp_sub);
    builder
    ...
    auto& sqrt_node = builder.add_library_node<math::tensor::ElementwiseNode>(
        sqrt_block, sqrt_block.debug_info(), math::cmath::CMathFunction::sqrt, element_type.primitive_type()
    );
    builder
