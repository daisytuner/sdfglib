...
TEST(MemletLinearization, FlattenTwoDimensionalArray) {
    ...
    auto& memlet = builder.add_reference_memlet(
        ...
        access_source,
        access_ptr,
        {symbolic::zero(), symbolic::integer(1), symbolic::integer(2)},
        pointer_to_array
    );
...
TEST(MemletLinearization, FlattenThreeDimensionalArray) {
    ...
    auto& memlet = builder.add_reference_memlet(
        ...
        access_source,
        access_ptr,
        {symbolic::zero(), symbolic::integer(1), symbolic::integer(2), symbolic::integer(3)},
        pointer_to_array
    );
...
TEST(MemletLinearization, FlattenWithSymbolicIndex) {
    ...
    auto& memlet =
        builder
            .add_reference_memlet(block, access_source, access_ptr, {symbolic::zero(), i_sym, j_sym}, pointer_to_array);
