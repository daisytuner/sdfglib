 ...
 */
class OffloadingNode : public data_flow::LibraryNode {
protected:
...
public:
    ...
    virtual bool redundant_with(const OffloadingNode& other) const;

    virtual bool equal_with(const OffloadingNode& other) const;
