...
class CUDATransform : public transformations::DedicatedMemoryAcceleratorOffloadTransform {
public:
    explicit CUDATransform(structured_control_flow::Map& map, int block_size = 32, bool allow_dynamic_sizes = false)
        : DedicatedMemoryAcceleratorOffloadTransform(map, allow_dynamic_sizes), block_size_(block_size) {};
