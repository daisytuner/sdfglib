...
class DedicatedMemoryAcceleratorOffloadTransform : public transformations::Transformation {
protected:
    structured_control_flow::Map& map_;
    bool allow_dynamic_sizes_ = false;

public:
    explicit DedicatedMemoryAcceleratorOffloadTransform(
        structured_control_flow::Map& map, bool allow_dynamic_sizes = false
    );
