#include "sdfg/transformations/dedicated_memory_accelerator_offload_transform.h"
...
DedicatedMemoryAcceleratorOffloadTransform::
    DedicatedMemoryAcceleratorOffloadTransform(structured_control_flow::Map& map, bool allow_dynamic_sizes)
    : map_(map), allow_dynamic_sizes_(allow_dynamic_sizes) {}

bool DedicatedMemoryAcceleratorOffloadTransform::
...
void DedicatedMemoryAcceleratorOffloadTransform::
...
void DedicatedMemoryAcceleratorOffloadTransform::handle_device_setup_and_teardown(
...
void DedicatedMemoryAcceleratorOffloadTransform::update_map_containers(const std::map<
                                                                       std::string,
                                                                       analysis::RegionArgument>& arguments) {
    for (auto& [argument, meta] : arguments) {
        if (meta.is_ptr) {
            auto argument_device = copy_prefix() + argument;
