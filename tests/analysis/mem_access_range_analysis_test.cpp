...
TEST(MemAccessRangeTest, Arg_Index_Write) {
    builder::StructuredSDFGBuilder builder("sdfg_arg_idx", FunctionType_CPU, DebugTable());
...
TEST(MemAccessRangeTest, Simple_2D_Map_Init) {
    builder::StructuredSDFGBuilder builder("sdfg_simple_2d", FunctionType_CPU, DebugTable());
...
TEST(MemAccessRangeTest, Incomplete_2D_Line_Sum) {
    builder::StructuredSDFGBuilder builder("sdfg_incomplete_2d", FunctionType_CPU, DebugTable());
