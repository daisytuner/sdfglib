...
TEST(WorkDepthTest, BlockSingleTasklet) {
    ...
    auto& one = builder.add_constant(block, "1", desc_type);
    builder.add_computational_memlet(block, one, tasklet, "_in", {});
...
TEST(WorkDepthTest, BlockMultipleTasklets) {
    ...
    auto& tasklet2 = builder.add_tasklet(block, data_flow::TaskletCode::int_add, "_out", {"_in0", "_in1"});
    auto& A = builder.add_access(block, "A");
    auto& B = builder.add_access(block, "B");
    auto& one = builder.add_constant(block, "1", desc_type);
    auto& zero = builder.add_constant(block, "0", desc_type);
    builder.add_computational_memlet(block, tasklet1, "_out", A, {});
    builder.add_computational_memlet(block, A, tasklet2, "_in0", {});
    builder.add_computational_memlet(block, tasklet2, "_out", B, {});
    builder.add_computational_memlet(block, one, tasklet2, "_in1", {});
    builder.add_computational_memlet(block, zero, tasklet1, "_in", {});
...
TEST(WorkDepthAnalysis, SequenceMultipleBlocks) {
    ...
    auto& zero = builder.add_constant(block1, "0", desc_type);
    builder.add_computational_memlet(block1, zero, tasklet1, "_in", {});
    builder.add_computational_memlet(block1, tasklet1, "_out", A, {});

    auto& block2 = builder.add_block(root);
    auto& tasklet2 = builder.add_tasklet(block2, data_flow::TaskletCode::int_add, "_out", {"_in0", "_in1"});
    auto& A_in = builder.add_access(block2, "A");
    auto& B = builder.add_access(block2, "B");
    auto& one = builder.add_constant(block2, "1", desc_type);
    builder.add_computational_memlet(block2, A_in, tasklet2, "_in0", {});
    builder.add_computational_memlet(block2, one, tasklet2, "_in1", {});
...
TEST(WorkDepthAnalysis, IfElse) {
    ...
    auto& tasklet1 = builder.add_tasklet(block1, data_flow::TaskletCode::assign, "_out", {"_in"});
    auto& tasklet1_2 = builder.add_tasklet(block1, data_flow::TaskletCode::int_add, "_out", {"_in0", "_in1"});
    auto& A = builder.add_access(block1, "A");
    auto& A_out = builder.add_access(block1, "A");
    auto& one = builder.add_constant(block1, "1", desc_type);
    auto& zero = builder.add_constant(block1, "0", desc_type);
    builder.add_computational_memlet(block1, zero, tasklet1, "_in", {});
    builder.add_computational_memlet(block1, tasklet1, "_out", A, {});
    builder.add_computational_memlet(block1, A, tasklet1_2, "_in0", {});
    builder.add_computational_memlet(block1, one, tasklet1_2, "_in1", {});
    ...
    auto& B = builder.add_access(block2, "B");
    auto& one_2 = builder.add_constant(block2, "1", desc_type);
    builder.add_computational_memlet(block2, A_in_2, tasklet2, "_in0", {});
    builder.add_computational_memlet(block2, one_2, tasklet2, "_in1", {});
    builder.add_computational_memlet(block2, tasklet2, "_out", B, {});
