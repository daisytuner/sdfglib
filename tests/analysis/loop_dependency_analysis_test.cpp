...
TEST(LoopDependencyAnalysisTest, TransposeTriangle_2D) {
    ...
    EXPECT_EQ(dependencies2.at("j"), analysis::LoopCarriedDependency::WAW);
}

TEST(LoopDependencyAnalysisTest, TransposeTriangle2_2D) {
    builder::StructuredSDFGBuilder builder("sdfg_test", FunctionType_CPU);
    ...
    EXPECT_EQ(dependencies1.at("j"), analysis::LoopCarriedDependency::WAW);
    EXPECT_EQ(dependencies2.size(), 1);
    EXPECT_EQ(dependencies2.at("A"), analysis::LoopCarriedDependency::RAW);
}
