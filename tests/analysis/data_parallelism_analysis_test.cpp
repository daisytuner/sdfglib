...
TEST(TestDataParallelism, Substitution_Affine) {
    ...
    auto res = analysis::DataParallelismAnalysis::substitution(
        {symbolic::add(symbolic::mul(symbolic::symbol("N"), symbolic::symbol("i")), symbolic::symbol("j"))},
        {symbolic::add(symbolic::mul(symbolic::symbol("N"), symbolic::symbol("i")), symbolic::symbol("j"))},
        "j",
        {},
        replacements,
    ...
    EXPECT_TRUE(symbolic::eq(res.first.at(0), symbolic::add(symbolic::symbol("c_0"), symbolic::symbol("j"))));
    EXPECT_TRUE(symbolic::eq(res.second.at(0), symbolic::add(symbolic::symbol("c_0"), symbolic::symbol("j"))));
}
...
TEST(TestDataParallelism, Reduction) {
    ...
    auto& tasklet =
        builder
            .add_tasklet(block, data_flow::TaskletCode::add, {"_out", base_desc}, {{"_in", base_desc}, {"1", base_desc}});
    builder.add_memlet(block, a1, "void", tasklet, "_in", {symbolic::integer(0)});
    builder.add_memlet(block, tasklet, "_out", a2, "void", {symbolic::integer(0)});
...
TEST(TestDataParallelism, Stencil_1D) {
    ...
    builder.add_memlet(block, A1, "void", tasklet, "_in1", {symbolic::sub(indvar, symbolic::integer(1))});
    builder.add_memlet(block, A2, "void", tasklet, "_in2", {indvar});
    builder.add_memlet(block, A3, "void", tasklet, "_in3", {symbolic::add(indvar, symbolic::integer(1))});
    builder.add_memlet(block, tasklet, "_out", B, "void", {indvar});
...
TEST(TestDataParallelism, Intervals_Disjoint_1D) {
    ...
    builder.add_memlet(block, tasklet, "_out", B, "void", {symbolic::add(indvar1, symbolic::symbol("N"))});
...
TEST(TestDataParallelism, Temporal_Loop_1D) {
    ...
    auto init1 = symbolic::integer(0);
    auto condition1 = symbolic::Lt(indvar1, symbolic::sub(symbolic::symbol("T"), symbolic::integer(1)));
    auto update1 = symbolic::add(indvar1, symbolic::integer(1));
    auto& loop1 = builder.add_for(root, indvar1, condition1, init1, update1);
    auto& body1 = loop1.root();
...
TEST(TestDataParallelism, Conditional_Tasklets_Readonly) {
    ...
    auto& tasklet =
        builder.add_tasklet(block2, data_flow::TaskletCode::assign, {"_out", base_desc}, {{"_in", base_desc}});
...
TEST(TestDataParallelism, Conditional_Tasklets_Private) {
    ...
    auto& tasklet1 =
        builder.add_tasklet(block1, data_flow::TaskletCode::assign, {"_out", base_desc}, {{"_in", base_desc}});
...
TEST(TestDataParallelism, Conditional_Tasklets_Dependent) {
    ...
    auto& tasklet1 =
        builder
            .add_tasklet(block1, data_flow::TaskletCode::add, {"_out", base_desc}, {{"_in", base_desc}, {"1", base_desc}});
...
TEST(TestDataParallelism, KernelTestBasic) {
    ...
    builder.add_memlet(
        ...
        tasklet,
        "_in",
        {symbolic::add(symbolic::threadIdx_x(), symbolic::mul(symbolic::blockDim_x(), symbolic::symbol("blockIdx.x")))}
    );
    builder.add_memlet(
        block,
        tasklet,
...
TEST(TestDataParallelism, Rodinia_SRAD) {
    ...
    auto& loop_i = builder.add_for(
        root,
        symbolic::symbol("i"),
        symbolic::Lt(symbolic::symbol("i"), symbolic::symbol("rows")),
        symbolic::integer(0),
...

    {
        ...
        auto& tasklet1 =
            builder.add_tasklet(block1, data_flow::TaskletCode::assign, {"_out", sym_desc}, {{"_in", sym_desc}});
        ...
        auto& tasklet2 =
            builder.add_tasklet(block2, data_flow::TaskletCode::assign, {"_out", sym_desc}, {{"_in", sym_desc}});
        ...
        auto& tasklet3 =
            builder.add_tasklet(block3, data_flow::TaskletCode::assign, {"_out", sym_desc}, {{"_in", sym_desc}});
        ...
        auto& tasklet4 =
            builder.add_tasklet(block4, data_flow::TaskletCode::assign, {"_out", sym_desc}, {{"_in", sym_desc}});
...

    {
        ...
        auto& tasklet11 =
            builder.add_tasklet(block, data_flow::TaskletCode::assign, {"_out", element_desc}, {{"_in", element_desc}});
        builder.add_memlet(
            block,
            J,
            "void",
            tasklet11,
            "_in",
            {symbolic::add(symbolic::mul(symbolic::symbol("i"), symbolic::symbol("cols")), symbolic::symbol("j"))}
        );
    ...
    // directional derivates
    {
        ...
        auto& tasklet1 = builder.add_tasklet(
            block1, data_flow::TaskletCode::sub, {"_out", element_desc}, {{"_in1", element_desc}, {"_in2", element_desc}}
        );
        builder.add_memlet(
            block1,
            J_node1,
            ...
            tasklet1,
            "_in1",
            {symbolic::add(symbolic::mul(symbolic::symbol("iN_i"), symbolic::symbol("cols")), symbolic::symbol("j"))}
        );
        ...
        auto& tasklet2 = builder.add_tasklet(
            block2, data_flow::TaskletCode::sub, {"_out", element_desc}, {{"_in1", element_desc}, {"_in2", element_desc}}
        );
        builder.add_memlet(
            block2,
            J_node2,
            ...
            tasklet2,
            "_in1",
            {symbolic::add(symbolic::mul(symbolic::symbol("iS_i"), symbolic::symbol("cols")), symbolic::symbol("j"))}
        );
        ...
        auto& tasklet3 = builder.add_tasklet(
            block3, data_flow::TaskletCode::sub, {"_out", element_desc}, {{"_in1", element_desc}, {"_in2", element_desc}}
        );
        builder.add_memlet(
            block3,
            J_node3,
            ...
            tasklet3,
            "_in1",
            {symbolic::add(symbolic::mul(symbolic::symbol("i"), symbolic::symbol("cols")), symbolic::symbol("jW_j"))}
        );
        ...
        auto& tasklet4 = builder.add_tasklet(
            block4, data_flow::TaskletCode::sub, {"_out", element_desc}, {{"_in1", element_desc}, {"_in2", element_desc}}
        );
        builder.add_memlet(
            block4,
            J_node4,
            ...
            tasklet4,
            "_in1",
            {symbolic::add(symbolic::mul(symbolic::symbol("i"), symbolic::symbol("cols")), symbolic::symbol("jE_j"))}
        );
    ...
    // G2
    {
        ...
        auto& tasklet2 = builder.add_tasklet(
            block1, data_flow::TaskletCode::mul, {"_out", element_desc}, {{"_in1", element_desc}, {"_in2", element_desc}}
        );
        builder.add_memlet(
            block1,
            dN_node1,
        ...
        auto& tasklet6 = builder.add_tasklet(
            block5, data_flow::TaskletCode::div, {"_out", element_desc}, {{"_in1", element_desc}, {"_in2", element_desc}}
        );
    ...
    // L
    {
        ...
        auto& tasklet1 = builder.add_tasklet(
            block1, data_flow::TaskletCode::add, {"_out", element_desc}, {{"_in1", element_desc}, {"_in2", element_desc}}
        );
        builder.add_memlet(
            block1,
            dN_node1,
        ...
        auto& tasklet2 = builder.add_tasklet(
            block2, data_flow::TaskletCode::add, {"_out", element_desc}, {{"_in1", element_desc}, {"_in2", element_desc}}
        );
        ...
        auto& tasklet3 = builder.add_tasklet(
            block3, data_flow::TaskletCode::add, {"_out", element_desc}, {{"_in1", element_desc}, {"_in2", element_desc}}
        );
        ...
        auto& Jc_node4 = builder.add_access(block4, "Jc");
        auto& tasklet4 = builder.add_tasklet(
            block4, data_flow::TaskletCode::div, {"_out", element_desc}, {{"_in1", element_desc}, {"_in2", element_desc}}
        );
    ...
    // else if (c[i * cols + j] > 1) {c[i * cols + j] = 1;}
    {
        ...
        auto& tasklet0 = builder.add_tasklet(
            block0, data_flow::TaskletCode::olt, {"_out", element_desc}, {{"_in", element_desc}, {"0", element_desc}}
        );
        builder.add_memlet(
            block0,
            c_node0,
        ...
        auto& tasklet1 = builder.add_tasklet(
            block1, data_flow::TaskletCode::ogt, {"_out", element_desc}, {{"_in", element_desc}, {"1", element_desc}}
        );
        builder.add_memlet(
            block1,
            c_node1,
        ...
        auto& tasklet2 =
            builder.add_tasklet(block2, data_flow::TaskletCode::assign, {"_out", element_desc}, {{"0", element_desc}});
        ...
        auto& tasklet3 =
            builder.add_tasklet(block3, data_flow::TaskletCode::assign, {"_out", element_desc}, {{"1", element_desc}});
