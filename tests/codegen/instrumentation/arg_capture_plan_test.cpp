...
TEST(ArgCapturePlanTest, CaptureInstrumentationInit) {
...
TEST(ArgCapturePlanTest, EmitArgInCaptures) {
    builder::StructuredSDFGBuilder builder("sdfg_a", FunctionType_CPU);
...
TEST(ArgCapturePlanTest, EmitArgOutCaptures) {
    builder::StructuredSDFGBuilder builder("sdfg_a", FunctionType_CPU);
    builder.add_container("arg0", types::Scalar(types::PrimitiveType::Int64), true, false);
    auto innerType = types::Array(types::Scalar(types::PrimitiveType::Float), symbolic::integer(210));
    builder.add_container("arg1", types::Pointer(static_cast<types::IType&>(innerType)), true, false);
 ...
 * any of its code.
 */
TEST(ArgCapturePlanTest, CreateCapturePlans) {
    builder::StructuredSDFGBuilder builder("sdfg_a", FunctionType_CPU);
...
TEST(ArgCapturePlanTest, CreateCapturePlans_Failure_OpaquePointer) {
    builder::StructuredSDFGBuilder builder("sdfg_a", FunctionType_CPU);
    ...
    codegen::CCodeGenerator generator(builder.subject(), analysis_manager, *instrumentation_plan, *arg_capture_plan);
    auto capturePlan = generator.create_capture_plans();
